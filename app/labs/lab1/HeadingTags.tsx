export default function HeadingTags() {
    return (
      <>
        ...
        <h4>Ethan Anthony</h4>
        Hi, I&apos;m Ethan and I enjoy <span id="wd-your-span">skiing</span>, reading, and programming!
        </div>
        <div id="wd-ai-headings">
            <h4>Lab notes</h4>
            These notes summarize the work done in this lab.
            <h5>What I built</h5>
            A short page that demonstrates the heading tags and how they nest.
            <h6>Next step</h6>
            Continue with the remaining tags covered in the next section.
        </div>
    </>
    );
  }
